...
public class MemberServiceImplV1 implements MemberService {
    ...
    public UserDetailsVO findById(String username) {
         ...
         * 결과를 Optional<UserDetailsVO> type으로 return을 한다
         * Optional로 감싸진 데이터는 null safe type의 데이터이다
         * null 으로 뭔가를 검사하려고 하면
         * 문제가 되기도 한다
         *
         * 결과값.orElse(리턴값) method를 사용하여
         * 결과값이 실제로 null 이면 orElse(리턴값)을 참조하여
         * 그 값을 연산 결과로 return을 해준다
         *
         * 이러한 원리를 이용하여
         * findById() 한 결과가 없으면 null을 return 하도록
         * 만들어 준다
         */
        // optional이라는 data type이기때문에 getter를 붙여줘야 한다.
